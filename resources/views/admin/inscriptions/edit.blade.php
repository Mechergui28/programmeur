            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <form  action="{{ route('admin.inscriptions.update',$inscriptions->id) }}" method="POST"  enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <!-- <input type="text" class="form-control" name="etat" value="{{$inscriptions->etat}}"> -->
                            ...
                            <div class="row" style="display: none;">
                                <input class="form-check-input" type="text" name="user_id" value="{{$inscriptions->user_id}}" >
                            </div>
