            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title">Ajouter nouveau inscription formation </h4>
                    </div>
                    <div class="card-content">
                        <form  action="{{ route('admin.inscriptionformations.store') }}" method="POST"  enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <a href="{{ route('admin.inscriptionformationss.index') }}" class="btn btn-danger">retour</a>
