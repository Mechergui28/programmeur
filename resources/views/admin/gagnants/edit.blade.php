            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <form  action="{{ route('admin.gagnants.update',$gagnants->id) }}" method="POST"  enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" name="rang" value="{{$gagnants->rang}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" name="prix" value="{{$gagnants->prix}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
